define([
  ...
  function InitialCriteriaViewModel(params) {
    ...
    self.primaryCriteriaOptions = [
      {
        ...
        action: function () {
          ...
          unwrappedExpression.PrimaryCriteria().CriteriaList.push({
      ...
      {
        ...constants.initialEventList.addImageOccurrence,
        selected: false,
        action: function () {
          var unwrappedExpression = ko.utils.unwrapObservable(self.expression);
          unwrappedExpression.PrimaryCriteria().CriteriaList.push({
            ImageOccurrence: new criteriaTypes.ImageOccurrence(
              null,
              unwrappedExpression.ConceptSets
            ),
          });
    ...
    self.removePrimaryCriteria = function (criteria) {
      ko.utils
        .unwrapObservable(self.expression)
        .PrimaryCriteria()
