define(function (require, exports) {
  ...
  var ImageOccurrence = require('./CriteriaTypes/ImageOccurrence');
  ...
  function GetCriteriaFromObject(data, conceptSets) {
    ...
    if (data.hasOwnProperty('ConditionOccurrence')) {
      return {
        ConditionOccurrence: new exports.ConditionOccurrence(
      ...
      return {
        ProcedureOccurrence: new exports.ProcedureOccurrence(
      ...
      return {
        VisitOccurrence: new exports.VisitOccurrence(
      ...
      return {
        DeviceExposure: new exports.DeviceExposure(
          data.DeviceExposure,
          conceptSets
        ),
      };
      ...
      return {
        ObservationPeriod: new exports.ObservationPeriod(
      ...
      return {
        PayerPlanPeriod: new exports.PayerPlanPeriod(
          data.PayerPlanPeriod,
          conceptSets
        ),
      };
    } else if (data.hasOwnProperty('LocationRegion')) {
      return {
        LocationRegion: new exports.LocationRegion(
          data.LocationRegion,
          conceptSets
        ),
      };
    } else if (data.hasOwnProperty('ImageOccurrence')) {
      return {
        ImageOccurrence: new exports.ImageOccurrence(
